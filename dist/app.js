...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(1)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, checkBoard_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var style = __webpack_require__(2);
    var iconfont = __webpack_require__(10);
    var mineClearance = (function () {
        ...
        mineClearance.prototype.initMine = function () {
            ...
            var _loop_1 = function (i, len) {
                var _loop_2 = function (j, len_1) {
                    ...
                    div.innerHTML = this_1.mine[i][j]["message"];
        ...
        mineClearance.prototype.createNineBox = function (x, y) {
            var temp = new Array();
            for (var i = -1; i < 2; i++) {
                for (var j = -1; j < 2; j++) {
                    if (x == x + i && y == y + j) {
